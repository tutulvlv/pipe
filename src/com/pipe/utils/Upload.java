...
public class Upload {
	public static String uploadExcel(HttpServletRequest request,MultipartFile file ,long date) throws IOException{
			String path=null;
//			String root = request.getRealPath("images/upload");
            if(file != null){  
                ...
                //如果名称不为“”,且以xls/xlsx 结尾 说明该文件可用，否则说明该文件不可处理  
                    ...
                    File temp = new File("d:/excel/upload");
